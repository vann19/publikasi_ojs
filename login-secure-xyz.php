    ...
    <div class="bg-white p-8 rounded-xl border border-gray-100 shadow-sm">
        ...
        <form id="login-form">
            <div class="mb-4">
                ...
                <input type="text" id="username" name="username" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500" required>
            </div>
