...
<head>
  ...
  <title>Tambah Seminar | Admin Nawa Edukasi</title>
        ...
        <main class="flex-1 overflow-y-auto p-6 sm:p-8">
            <div class="max-w-2xl mx-auto">
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    <h2 class="text-xl font-bold text-gray-900 mb-1">Tambah Seminar Baru</h2>
                    <p class="text-sm text-gray-500 mb-6 pb-4 border-b border-gray-100">Isi formulir berikut untuk menambahkan acara seminar atau workshop.</p>
                    ...
                    <form id="form-seminar" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" placeholder="Contoh: Seminar Nasional Penelitian 2025"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="4" placeholder="Deskripsi singkat tentang seminar..."
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#1E1B3A]/20 focus:border-[#1E1B3A] outline-none transition resize-none"></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="location" placeholder="Contoh: Online (Zoom) / Aula Kampus"
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#1E1B3A]/20 focus:border-[#1E1B3A] outline-none transition">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="number" name="price" min="0" placeholder="Kosongkan jika Gratis"
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#1E1B3A]/20 focus:border-[#1E1B3A] outline-none transition">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-xs text-gray-400">Format: JPG, PNG, WebP. Maks. 2 MB.</p>
...
document.getElementById('form-seminar').addEventListener('submit', async (e) => {
    ...
    try {
        const res = await fetch('/api/add-seminar.php', { method: 'POST', body: new FormData(e.target) });
        ...
        if (data.status === 'success') {
            ...
            btn.disabled = false;
            btn.innerHTML = '<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg> Simpan Seminar';
        }
    } catch {
