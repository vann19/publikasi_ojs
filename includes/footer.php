  ...
  <!-- Footer -->
  <footer class="bg-[#1E1B3A] text-gray-300 mt-24">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div class="col-span-1 md:col-span-2">
          ...
          <p class="text-sm text-gray-400 leading-relaxed max-w-sm">
            ...
            dan publikasi jurnal ilmiah, dengan komitmen mendukung pengembangan ilmu pengetahuan dan
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm text-gray-400">
            <li class="flex gap-2">
              ...
              <span>Jl. Gua Selarong No. 54, Dusun Gayam RT 06, Ringinharjo, Bantul, Daerah Istimewa Yogyakarta</span>
            </li>
            <li class="flex gap-2">
              ...
              <a href="https://wa.me/6281916200962" class="hover:text-white transition-colors">0819-1620-0962</a>
            </li>
            <li class="flex gap-2">
              <svg class="w-4 h-4 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
              <a href="mailto:nawaedukasinusantara@gmail.com" class="hover:text-white transition-colors break-all">nawaedukasinusantara@gmail.com</a>
            </li>
          </ul>
        </div>
      </div>

      <div class="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
        <p>&copy; <?php echo date('Y'); ?> PT Nawa Edukasi Nusantara. Hak cipta dilindungi.</p>
