  ...
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <?php foreach ($seminarList as $s): ?>
        ...
        ?>
        <div class="rounded-xl border border-gray-100 overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col group">
          <!-- Cover / Poster -->
